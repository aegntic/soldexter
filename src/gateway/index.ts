...
async function promptSetupMode(cfg: GatewayConfig, linkedPhone: string): Promise<void> {
  ...
  try {
    ...
    console.log('');
    console.log('How will you use Soldexter with WhatsApp?');
    console.log('  1) Self-chat  — message yourself to talk to Soldexter');
    console.log('  2) Bot phone  — this is a dedicated Soldexter phone, others message it');
    ...
    console.log('');
    console.log('Enter the phone number(s) allowed to message Soldexter (E.164 format, e.g. +15551234567).');
...
async function run(): Promise<void> {
  ...
  console.log('Soldexter gateway running. Press Ctrl+C to stop.');
